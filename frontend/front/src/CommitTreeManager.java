...
public class CommitTreeManager {
  ...
  static void decompressBlob(String distFilePath, String hash) {
    // blobオブジェクトを展開
    // まずはblobオブジェクトが存在するか確認
    String firstTwoChars = hash.substring(0, 2);
    String rest = hash.substring(2);
    String fileObjectPath = ".mogit/objects/" + firstTwoChars + "/" + rest;
